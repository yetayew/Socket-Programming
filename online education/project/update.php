...
if(isset($_POST['submit'])){
  ...
  if(!empty($fname)){
   ...
   $message[] = 'user first_name updated successfully!';
  }
...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            <p>your first name</p>
            <input type="text" name="fname" placeholder="<?= $fetch_profile['first_name']; ?>" maxlength="100" class="box">
            <p>your last name</p>
            <input type="text" name="lname" placeholder="<?= $fetch_profile['last_name']; ?>" maxlength="100" class="box">
            <p>your email</p>
